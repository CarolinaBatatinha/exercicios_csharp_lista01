// 12.	Desenvolva um algoritmo para calcular o montante resultante de um capital aplicado a juros compostos. Você deve pedir o capital (C), a taxa de juros (I) e o tempo (N). Com essas variáveis, você deve calcular o montante (M) pela fórmula:
// •	M < - C * (1+(I/100)) ^N
...
class Program
{
    static void Main(string[] args)
    {
        ...
        double montante = Math.Round(
            capitalInicial * Math.Pow(1 + (taxaJuros / 100), tempoMeses),
            2
        );
