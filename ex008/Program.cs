...
class Program
{
    static void Main(string[] args)
    {
        ...
        // a estrutura DateTime representa um momento no tempo, geralmente expresso como uma data ou hora do dia. Na expressão desse caso, a estrutura manipula e exibe o ano atual.
